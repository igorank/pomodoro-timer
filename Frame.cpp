	...
	wxSize(width, height), wxDEFAULT_FRAME_STYLE & ~(wxRESIZE_BORDER | wxMAXIMIZE_BOX))
{
	...
	wxStaticBitmap* image = new wxStaticBitmap(parent, wxID_ANY, wxBitmap("data\\timer.png", wxBITMAP_TYPE_PNG),wxPoint(64,0),wxSize(256,256));
	...
	buttons_sizer->Add(stopbutton, 0, wxLEFT | wxRIGHT, 15);
	buttons_sizer->Add(startbutton, 0, wxLEFT | wxRIGHT, 15);
	buttons_sizer->Add(pausebutton, 0, wxLEFT | wxRIGHT, 15);
	...
	top_sizer->Add(buttons_sizer, 0, wxALIGN_CENTER | wxTOP, -15);
